...
<template>
  <footer
    class="footer mt-12 flex items-center justify-between bg-primary p-4 text-neutral-content"
  >
    ...
    <nav class="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
      <NuxtLink to="https://twitter.com/ur_growth"
        ...
        >
          ...
          ></path></svg
      ></NuxtLink>
      <NuxtLink to="https://youtube.com/@ur_growth"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
        ...
        >
          ...
          ></path></svg
      ></NuxtLink>
      <NuxtLink to="https://facebook.com/OUTFREAK.OFFICIAL"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
