...
This document outlines security procedures and general policies for the `urgrowth's website`
project.
...
The `urgrowth` team and community take all security bugs in `urgrowth's website` seriously. Thank you for improving the security
of `urgrowth's website`. We appreciate your efforts and responsible disclosure and will make every effort to acknowledge your
contributions.
